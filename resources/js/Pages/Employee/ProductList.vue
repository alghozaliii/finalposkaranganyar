        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                    <h3 class="font-medium text-lg">Daftar Stok Produk</h3>
                    <p class="mb-4">Berikut adalah daftar semua produk yang tersedia.</p>
...
<thead>
    <tr>
        ...
        <th class="py-2 px-4 border-b bg-gray-100 text-left text-sm font-semibold text-gray-700">Keuntungan/Produk</th>
...
<tbody>
    ...
    <tr v-for="product in products" :key="product.id" class="hover:bg-gray-50">
        ...
        <td class="py-2 px-4 border-b">Rp {{ Number(product.profit).toLocaleString() }}</td>
