<template>
    <GuestLayout>
        ...
        <!-- Full page background with gradient color -->
        <section class="fixed inset-0 bg-gradient-to-b from-purple-400 to-violet-900 overflow-y-auto">
            <div class="w-full max-w-2xl px-6 py-8 mx-auto">
                <!-- Status Message -->
                ...
                <form @submit.prevent="submit" enctype="multipart/form-data" class="space-y-6 bg-white/30 backdrop-blur-900/60 p-6 rounded-2xl border border-white-800 backdrop-blur-sm shadow-xl">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="name" type="text" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="email" type="email" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                                        v-model="form.email" required autocomplete="username" placeholder="Masukkan alamat email" />
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="password" type="password" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                                        v-model="form.password" required autocomplete="new-password" placeholder="Buat password" />
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="password_confirmation" type="password" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                                        v-model="form.password_confirmation" required autocomplete="new-password" placeholder="Konfirmasi password" />
                                </div>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="store_name" type="text" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="address" type="text" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="nik" type="text" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <TextInput id="phone" type="text" class="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 text-white text-base placeholder-white/60 border border-white/20 focus:border-violet-400 focus:ring focus:ring-violet-300 focus:ring-opacity-50" 
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    <div class="mt-1">
                                        <div class="border-2 border-dashed border-white/20 rounded-xl px-4 py-4 bg-white/10 hover:border-violet-400 transition-colors duration-300">
                                            <div class="flex flex-col items-center justify-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-50 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                </svg>
                                                <p class="text-sm text-gray-100 mb-2">Klik untuk upload foto KTP</p>
                                    ...
                                    <div class="mt-1">
                                        <div class="border-2 border-dashed border-white/20 rounded-xl px-4 py-4 bg-white/10 hover:border-violet-400 transition-colors duration-300">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <p class="text-sm text-gray-100 mb-2">Klik untuk upload foto selfie</p>
                ...
                <!-- Additional information or branding -->
